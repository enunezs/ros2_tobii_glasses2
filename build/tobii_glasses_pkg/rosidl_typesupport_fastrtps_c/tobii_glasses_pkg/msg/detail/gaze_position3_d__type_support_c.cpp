...
#include "tobii_glasses_pkg/msg/detail/gaze_position3_d__rosidl_typesupport_fastrtps_c.h"
...
using _GazePosition3D__ros_msg_type = tobii_glasses_pkg__msg__GazePosition3D;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _GazePosition3D__ros_msg_type * ros_message = static_cast<const _GazePosition3D__ros_msg_type *>(untyped_ros_message);
  ...
  {
    size_t size = 3;
    auto array_ptr = ros_message->gaze_position_3d;
  ...
  void * untyped_ros_message)
{
  ...
  _GazePosition3D__ros_msg_type * ros_message = static_cast<_GazePosition3D__ros_msg_type *>(untyped_ros_message);
  // Field name: glasses_header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _GazePosition3D__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tobii_glasses_pkg__msg__GazePosition3D(
...
{
  return max_serialized_size_tobii_glasses_pkg__msg__GazePosition3D(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_GazePosition3D = {
...
static rosidl_message_type_support_t _GazePosition3D__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_GazePosition3D,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tobii_glasses_pkg, msg, GazePosition3D)() {
  return &_GazePosition3D__type_support;
}
