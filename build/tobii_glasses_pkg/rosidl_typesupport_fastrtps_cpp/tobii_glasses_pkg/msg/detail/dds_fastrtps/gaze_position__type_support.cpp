...
#include "tobii_glasses_pkg/msg/detail/gaze_position__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tobii_glasses_pkg::msg::GazePosition & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tobii_glasses_pkg::msg::GazePosition & ros_message)
{
  // Member: glasses_header
...
{
  auto typed_message =
    static_cast<const tobii_glasses_pkg::msg::GazePosition *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tobii_glasses_pkg::msg::GazePosition *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GazePosition__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const tobii_glasses_pkg::msg::GazePosition *>(
...
{
  return max_serialized_size_GazePosition(full_bounded, 0);
}

static message_type_support_callbacks_t _GazePosition__callbacks = {
...
static rosidl_message_type_support_t _GazePosition__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GazePosition__callbacks,
...
{
  return &tobii_glasses_pkg::msg::typesupport_fastrtps_cpp::_GazePosition__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tobii_glasses_pkg, msg, GazePosition)() {
  return &tobii_glasses_pkg::msg::typesupport_fastrtps_cpp::_GazePosition__handle;
}
