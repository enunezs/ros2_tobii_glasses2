...
#include "tobii_glasses_pkg/msg/detail/eye_data__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  {
    size_t array_size = 3;
    size_t item_size = sizeof(ros_message.pupil_center[0]);
  ...
  {
    size_t array_size = 3;
    size_t item_size = sizeof(ros_message.gaze_direction[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
{
  auto typed_message =
    static_cast<const tobii_glasses_pkg::msg::EyeData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tobii_glasses_pkg::msg::EyeData *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _EyeData__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const tobii_glasses_pkg::msg::EyeData *>(
...
{
  return max_serialized_size_EyeData(full_bounded, 0);
}

static message_type_support_callbacks_t _EyeData__callbacks = {
...
static rosidl_message_type_support_t _EyeData__handle = {
...
{
  return &tobii_glasses_pkg::msg::typesupport_fastrtps_cpp::_EyeData__handle;
}
