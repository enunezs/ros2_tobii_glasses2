...
static const _TobiiGlasses_type_support_symbol_names_t _TobiiGlasses_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tobii_glasses_pkg, msg, TobiiGlasses)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tobii_glasses_pkg, msg, TobiiGlasses)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, tobii_glasses_pkg, msg, TobiiGlasses)() {
  return &::tobii_glasses_pkg::msg::rosidl_typesupport_c::TobiiGlasses_message_type_support_handle;
}
