...
if(_tobii_glasses_pkg_CONFIG_INCLUDED)
  # ensure to keep the found flag the same
  if(NOT DEFINED tobii_glasses_pkg_FOUND)
    # explicitly set it to FALSE, otherwise CMake will set it to TRUE
    set(tobii_glasses_pkg_FOUND FALSE)
  elseif(NOT tobii_glasses_pkg_FOUND)
    # use separate condition to avoid uninitialized variable warning
    set(tobii_glasses_pkg_FOUND FALSE)
  endif()
  return()
endif()
set(_tobii_glasses_pkg_CONFIG_INCLUDED TRUE)
...
if(NOT "" STREQUAL "")
  set(_msg "Package 'tobii_glasses_pkg' is deprecated")
  # append custom deprecation text if available
  if(NOT "" STREQUAL "TRUE")
    set(_msg "${_msg} ()")
  endif()
  # optionally quiet the deprecation message
  if(NOT ${tobii_glasses_pkg_DEPRECATED_QUIET})
    message(DEPRECATION "${_msg}")
  endif()
endif()

# flag package as ament-based to distinguish it after being find_package()-ed
set(tobii_glasses_pkg_FOUND_AMENT_PACKAGE TRUE)
...
foreach(_extra ${_extras})
  include("${tobii_glasses_pkg_DIR}/${_extra}")
endforeach()
