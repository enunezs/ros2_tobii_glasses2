...
bool tobii_glasses_pkg__msg__gaze_position__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tobii_glasses_pkg.msg._gaze_position.GazePosition", full_classname_dest, 49) == 0);
  }
  tobii_glasses_pkg__msg__GazePosition * ros_message = _ros_message;
  {  // glasses_header
...
{
  /* NOTE(esteve): Call constructor of GazePosition */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tobii_glasses_pkg.msg._gaze_position");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GazePosition");
